...
{
    class InterceptedIncident_SkyFaller_CenterDrop : InterceptedIncident_SkyFaller
    {
        ...
        {
            IncidentInterceptorUtility.isIntercepting_CenterDrop = false;
            ...
            IncidentInterceptorUtility.isIntercepting_CenterDrop = true;
        }
